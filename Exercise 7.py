...
def check_path(path):
    if os.path.exists(path) == True:
        list_results = [str(os.path.isabs(path)),str(os.path.isdir(path)),str(os.path.isfile(path))]
        return str(os.path.exists(path)), list_results
    else:
        return 'False', list('')
