...
def check_path(path):
    ...
    abs_result = os.path.isabs(path)
    dir_result = os.path.isdir(path)
    file_result = os.path.isfile(path)
    if abs_result or dir_result or file_result:
        return True, [abs_result, dir_result, file_result]
    else:
        return False, []

# print(check_path('some/path/of/a/directory'))
