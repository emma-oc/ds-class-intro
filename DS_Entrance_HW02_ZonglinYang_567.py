...
def check_path(path):
    if os.path.exists(path):
        ...
        return True, [p_absolute, p_directory, p_file]
    
    else:
        return False, []    
    
check_path('C:\\Users\\13125\\Desktop\\2020Spring\\CSC555-DataMining')
check_path('D:\\Users\\13125\\Desktop')
...
import os
os.getcwd()
os.chdir('C:\\Users\\13125\\Desktop')
...
def write_csv(data_list, output_file):
    fd = open(output_file, 'w', newline='')
    with fd:
        csv.writer(fd).writerows(data_list)
